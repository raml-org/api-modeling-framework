(ns api-modeling-framework.generators.syntax.jsonld
  #?(:cljs (:require [api-modeling-framework.platform :as platform]
                     [api-modeling-framework.model.vocabulary :as v]))

  #?(:clj (:require [api-modeling-framework.platform :as platform]
                    [api-modeling-framework.model.vocabulary :as v])))
